...
//		*actual_displaying_frame_final_ = *actual_displaying_frame_2_;
		aligner.InitialAlign(actual_displaying_frame_1_, actual_displaying_frame_final_);
		*actual_displaying_frame_final_ += *actual_displaying_frame_2_;
		glBegin(GL_POINTS);
...
ThorClientSystem::ThorClientSystem(int iResourceID, char* sWindowName) : cOpenGLWindow(iResourceID, sWindowName)
{
	...
	client_recievers_[0] = new ThorClientReciever(SENDING_PORT_1, RECIEVING_PORT_1, SERVER_1);
	client_recievers_[1] = new ThorClientReciever(SENDING_PORT_2, RECIEVING_PORT_2, SERVER_2);
	rotation_x_ = 0.0f;
	rotation_y_ = 0.0f;
	x_axis_pos = 0.0f;
